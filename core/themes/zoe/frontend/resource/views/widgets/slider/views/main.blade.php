<div id="sequence">
    <ul class="sequence-canvas">
        ...
        <li class="bg4">
            ...
            <!-- Slide Image -->
            <img class="slide-img" src="{{asset('theme/zoe/img/homepage-slider/slide1.png')}}" alt="Slide 1"/>
        </li>
        <!-- End Slide 1 -->
        <!-- Slide 2 -->
        <li class="bg3">
            ...
            <!-- Slide Image -->
            <img class="slide-img" src="{{asset('theme/zoe/img/homepage-slider/slide2.png')}}" alt="Slide 2"/>
        </li>
        <!-- End Slide 2 -->
        <!-- Slide 3 -->
        <li class="bg1">
            ...
            <!-- Slide Image -->
            <img class="slide-img" src="{{asset('theme/zoe/img/homepage-slider/slide3.png')}}" alt="Slide 3"/>
        </li>
        <!-- End Slide 3 -->
    </ul>
