    ...
    <div id="masthead" class="header-main nav-dark">
        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
            <div id="logo" class="flex-col logo">
                <a href="{!! router_frontend_lang('page:home') !!}" title="Miss Terry® Escape Rooms - Unravel The Mystery!" rel="home">
            ...
            <div class="flex-col hide-for-medium flex-right">
                ...
                <ul class="header-nav header-nav-main nav nav-right  nav-divided nav-size-medium">
                    ...
                    <li id="menu-item-3574-en" class="lang-item lang-item-54 lang-item-en current-lang lang-item-first menu-item menu-item-type-custom menu-item-object-custom current_page_item menu-item-home menu-item-3574-en menu-item-design-default">
                        <a href="{!! route('frontend:en_page:home') !!}" hreflang="en-US" lang="en-US" class="nav-top-link">
                    ...
                    <li id="menu-item-3574-vi" class="lang-item lang-item-57 lang-item-vi menu-item menu-item-type-custom menu-item-object-custom menu-item-3574-vi menu-item-design-default">
                        <a href="{!! route('frontend:vi_page:home') !!}" hreflang="vi" lang="vi" class="nav-top-link">
                    ...
                    <li class="html header-button-1">
                        <div class="header-button">
                            <a href="@php $_router_name =  Route::currentRouteName(); echo ($_router_name == "frontend:vi_page:home" || $_router_name == "frontend:en_page:home" || $_router_name == "frontend:page:home")?"#book":router_frontend_lang('page:home')  @endphp" class="button primary"  style="border-radius:99px;">
