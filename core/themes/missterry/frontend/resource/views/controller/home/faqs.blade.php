                    ...
                    <div id="col-1018626156" class="col medium-6 small-12 large-6">
                        <div class="col-inner">
                            ...
                            <div class="accordion" rel="">
                                ...
                                <div class="accordion-item"><a href="#" class="accordion-title plain"><button class="toggle"><i class="icon-angle-down"></i></button><span>Accordion Item 3 Title</span></a><div class="accordion-inner">
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
                                    </div></div>
                            </div>
                        </div>
