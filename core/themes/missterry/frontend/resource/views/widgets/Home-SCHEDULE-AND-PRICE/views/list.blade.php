...
<section class="section" id="book">
    ...
    <div class="section-content relative">
        <div class="container section-title-container">
            <h3 class="section-title section-title-normal"><b></b><span class="section-title-main" style="font-size:150%;">{!! z_language('SCHEDULE AND PRICE') !!}</span><b></b></h3></div>
        <div class="container1" style="padding: 15px 20px 0px;width: 95%;margin: 0 auto;">
            ...
            <div id="phobia-mobile-schedule">
                ...
                <div id="schedule-controls">
                    <p class="schedule-control_month">January</p>
                    <div>
                        <a class="schedule-control go_to" href=".day_8" title="Нажмите, чтобы перейти к расписанию на 8 January">8</a>
                        <span class="control-sub"> Fri</span>
                    </div>
                    <div class="holiday">
                        <a class="schedule-control go_to" href=".day_9" title="Нажмите, чтобы перейти к расписанию на 9 January">9</a>
                        <span class="control-sub"> Sat</span>
                    </div>
                    <div class="holiday">
                        <a class="schedule-control go_to" href=".day_10" title="Нажмите, чтобы перейти к расписанию на 10 January">
                ...
                <div id="schedule-schedules">
                    <div>
                        ...
                        <div class="schedule-day-content">
                            <div class="priceline">
                                <div class="priceline__price">
                                    <span class="" style="display: block; font-size: 0.8rem; opacity: 0.8; text-align: center">from</span><span>4000 ₽</span>
                                </div>
                                <div class="pl_timeslot pl_prepay">
                            ...
                            <div class="priceline">
                                <div class="priceline__price">
                                    <span class="" style="display: block; font-size: 0.8rem; opacity: 0.8; text-align: center">from</span><span>5000 ₽</span>
                                </div>
                                <div class="pl_timeslot pl_prepay">
