<div class="page-title blog-featured-title featured-title no-overflow">
    <div class="page-title-bg fill">
        <div class="title-bg fill bg-fill bg-top parallax-active"
             style="background-image: url(https://demo.missterry.vn/wp-content/uploads/2019/07/student-discount-01-568x553-1.jpg); height: 434.778px; transform: translate3d(0px, -0.11px, 0px); backface-visibility: hidden;" data-parallax-fade="true" data-parallax="-2" data-parallax-background="" data-parallax-container=".page-title"></div>
