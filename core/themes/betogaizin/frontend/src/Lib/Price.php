...
class Price{
    ...
    public function prices($datas){
        ...
        foreach ($datas as $key=>$value){
            ...
            $products_group[$value['cate']]['products'][] = $value;
        }
        ...
        foreach ($products_group as $key => $value){
            if($value['name'] == "YAMADA"){
                $results[$value['name']] = $this->YAMADA($key,$value);
            }
        }

        dd($results,$products_group,$datas,$this->data);
    }
...
//        $products['ship'] = $price_ship;
    ...
    public function KOGYJA($products,$provincev = "",$type = ""){

    }
    public function KURICHIKU(){

    }
    public function FUKUI($products,$provincev = "",$type = ""){

    }
    public function OHGA($products,$provincev = "",$type = ""){
