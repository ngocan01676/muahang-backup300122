@section('content')
    ...
    <div id="page-header-294074017" class="page-header-wrapper">
        <div class="page-title dark featured-title">
            ...
            <style>
                #page-header-294074017 .page-title-inner {
                    min-height: 268px;
                }
                #page-header-294074017 .title-bg {
                    background-image: url({!! asset('theme/missterry/images/IMG_2769-1.jpg') !!});
                }
                #page-header-294074017 {
    ...
    <section class="section" id="section_1882382371">
        ...
        <div class="section-content relative">
            ...
            <div class="row" id="row-779799116">

                <div id="col-1209456769" class="col small-12 large-12">
                                        ...
                                        <div class="box box-normal box-text-bottom box-blog-post has-hover">
                                            ...
                                            <div class="box-text text-center">
                                                <div class="box-text-inner blog-post-inner">
                                                    ...
                                                    <div class="post-meta is-small op-8">April 27, 2018</div>					<div class="is-divider"></div>
                                        ...
                                        <div class="box box-normal box-text-bottom box-blog-post has-hover">
                                            ...
                                            <div class="box-text text-center">
                                                <div class="box-text-inner blog-post-inner">
                                                    ...
                                                    <div class="post-meta is-small op-8">May 26, 2018</div>					<div class="is-divider"></div>
