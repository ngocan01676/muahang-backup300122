                        ...
                        <div class="lyt-side-pattern02-main">
                            <div class="box box-primary box-full-width-sp mt40">
                                ...
                                <ul class="list-disc">
                                    ...
                                    <li>
                                       Chuyển khoản ゆうちょ銀行 : 10520-88041461 　カ）トカイリンコーポレーツョン
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="side-content-frame">
                                        ...
                                        <div class="side-content-frame-data-group">
                                                <dl class="side-content-frame-data">
                                                    ...
                                                    <dd class="side-content-frame-data-body"><span class="side-content-frame-num">{!! number_format($prices['total_profit']+$prices['total_sum']+$prices['total_cou']) !!}</span>
