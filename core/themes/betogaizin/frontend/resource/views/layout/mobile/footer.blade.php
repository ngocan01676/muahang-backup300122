...
<div class="popup-wrap" style="position: absolute; height: auto;display: none">
    ...
    <section data-v-7394c006="" class="popup popup-narrow">
        ...
        <h2 data-v-7394c006="" class="popup-head">{!! z_language('お届け日時選択') !!}</h2>
        <div data-v-7394c006="" class="popup-content delivery-content" style="height: auto;">
            ...
            <div data-v-7394c006="" class="delivery-footer">
                <ul data-v-7394c006="" class="delivery-icon-list">
                    <li data-v-7394c006=""><i data-v-7394c006="" class="svg-icon icon-18 icon-possible"></i>：{!! z_language('空きあり') !!}</li>
                    <li data-v-7394c006=""><i data-v-7394c006="" class="svg-icon icon-18 icon-slightly"></i>：{!! z_language('残りわずか') !!}</li>
                    <li data-v-7394c006=""><i data-v-7394c006="" class="svg-icon icon-18 icon-impracticably-dark"></i>：{!! z_language('受付終了') !!}</li>
                </ul>
                <div data-v-7394c006="" id="delivery-info" class="delivery-info">
                    <dl data-v-7394c006="" class="delivery-info-list">
                        <dt data-v-7394c006="" class="delivery-info-list-heading">{!! z_language('お届け日時') !!}</dt>
                        <dd data-v-7394c006="" class="delivery-info-list-note only-sp">{!! z_language('この時間帯は必ずご在宅ください') !!}</dd>
                        ...
                        <dd data-v-7394c006="" class="delivery-info-list-note only-pc">{!! z_language('この時間帯は必ずご在宅ください') !!}</dd>
                    </dl>
                    <!----> <!----> <!----> <!---->
                    <dl data-v-7394c006="" class="delivery-info-list">
                        <dt data-v-7394c006="" class="delivery-info-list-heading">{!! z_language('お届け先') !!}</dt>
                        <dd data-v-7394c006="" class="delivery-info-list-txt">{!! z_language('東京都新宿区箪笥町') !!}　</dd>
