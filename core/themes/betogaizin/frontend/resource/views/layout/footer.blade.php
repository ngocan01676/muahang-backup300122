...
<script src="{!! asset('/theme/betogaizin/plugins/EasyAutocomplete/jquery.easy-autocomplete.min.js') !!}"></script>
...
<script>
    $(document).ready(function () {
        var options = {
            ...
            url: function(phrase) {
                return "{!! router_frontend_lang('widget:WidgetSearchAutocomplete') !!}?kw="+phrase;
            },
            getValue: "name",
