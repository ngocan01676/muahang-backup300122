        ...
        <div class="box-body clearfix">
            <ul class="timeline timeline-inverse builds">
                ...
                @foreach($lists as $list)
                    ...
                    @endphp
                    <li data-id="{!! $list->id !!}" data-type="{!! $list->type_group !!}">
...
@push('scripts')
    ...
    <script>
        ...
        function OpenSource(self) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{route('backend:plugin:layout:ajax:build')}}',
                data: data,
