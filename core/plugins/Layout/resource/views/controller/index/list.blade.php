...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{!! asset('/plugins/layout/plugins/bootstrap-3.4.1/css/bootstrap.min.css') !!}" data-type="keditor-style" />
        <link rel="stylesheet" type="text/css" href="{!! asset('/plugins/layout/plugins/font-awesome-4.7.0/css/font-awesome.min.css') !!}" data-type="keditor-style" />
        <!-- Start of KEditor styles -->
        <link rel="stylesheet" type="text/css" href="{!! asset('/plugins/layout/dist/css/keditor.css') !!}" data-type="keditor-style" />
        <link rel="stylesheet" type="text/css" href="{!! asset('/plugins/layout/dist/css/keditor-components.css') !!}" data-type="keditor-style" />
        <!-- End of KEditor styles -->
        <link rel="stylesheet" type="text/css" href="{!! asset('/plugins/layout/plugins/code-prettify/src/prettify.css') !!}" />
    ...
    <body>
        ...
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/jquery-1.11.3/jquery-1.11.3.min.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/bootstrap-3.4.1/js/bootstrap.min.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/jquery-ui-1.12.1.custom/jquery-ui.min.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/ckeditor-4.11.4/ckeditor.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/formBuilder-2.5.3/form-builder.min.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/formBuilder-2.5.3/form-render.min.js') !!}"></script>
        ...
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/js-beautify-1.7.5/js/lib/beautify.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('/plugins/layout/plugins/js-beautify-1.7.5/js/lib/beautify-html.js') !!}"></script>
    ...
    <body>
      <div class="keditor-ui keditor-topbar" id="keditor-ui-15689129083501545951962">
          <div class="keditor-ui keditor-topbar-left">
              <div class="keditor-ui keditor-topbar-title" title="Editing with KEditor">Editing with KEditor</div>
          </div>
          <div class="keditor-ui keditor-topbar-center">
          <a href="javascript:void(0);" title="View on mobile" class="keditor-ui keditor-topbar-btn active" data-width="420px"><i class="fa fa-fw fa-mobile"></i></a>
          <a href="javascript:void(0);" title="View on tablet" class="keditor-ui keditor-topbar-btn" data-width="820px"><i class="fa fa-fw fa-tablet"></i></a>
          <a href="javascript:void(0);" title="View on laptop" class="keditor-ui keditor-topbar-btn" data-width="1050px"><i class="fa fa-fw fa-laptop"></i></a>
          <a href="javascript:void(0);" title="View on desktop" class="keditor-ui keditor-topbar-btn" data-width="1250px"><i class="fa fa-fw fa-desktop"></i></a>
        </div>
          <div class="keditor-ui keditor-topbar-right">
          <a href="javascript:void(0);" title="Preview OFF" class="keditor-ui keditor-topbar-btn"><i class="fa fa-fw fa-eye-slash"></i></a><a href="javascript:void(0);" title="Fullscreen Off" class="keditor-ui keditor-topbar-btn"><i class="fa fa-fw fa-expand"></i></a><a href="javascript:void(0);" title="Save" class="keditor-ui keditor-topbar-btn"><i class="fa fa-fw fa-save"></i></a></div>
      </div>
