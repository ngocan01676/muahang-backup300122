...
<table class="table table-bordered">
    ...
    <tr class="text-center">
        <th width="150">
            <label for="text" class="control-label">{!! z_language('Site Name') !!}</label>
        </th>
        <td>
    ...
    <tr>
        <th><label for="short_date" class="control-label">Short date</label></th>
        <td>
            <div class="col-md-6 col-xs-12">
                @php
                    $short_dates = [
    ...
    <tr>
        <th><label for="long_date" class="control-label">Long date</label></th>
        <td>
            <div class="col-md-6 col-xs-12">
                @php
                    $long_dates = [
    ...
    <tr>
        <th><label class="control-label" for="site_language">Site languages</label></th>
        <td>
            <div class="col-md-6 col-xs-12">
