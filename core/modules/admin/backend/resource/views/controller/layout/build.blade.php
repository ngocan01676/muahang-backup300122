    ...
    <div class="box box box-zoe">
        <div class="box-body clearfix">
            <ul class="timeline timeline-inverse builds">
                <li class="time-label">
                    <button action="0" class="btn  btn-default" style="margin-left: 7px;" onclick="BuildAll(this,'build')">Build</button>
                </li>
                ...
                <li data-id="{!! $list->id !!}">
                    ...
                    <div class="timeline-item">
                           ...
                           <h3 class="timeline-header">{!! $list->name !!}
                            ...
                            <div class="timeline-footer">
                                <a href="{!! route('backend:layout:edit',["id"=>$list->id]) !!}" class="btn btn-primary btn-xs">{!! z_language('Edit') !!}</a> &nbsp;
                                <a onclick="Action(this)" class="btn btn-primary btn-xs build" data-act="build" data-id="{!! $list->id !!}">{!! z_language('Build') !!}</a> &nbsp;
                                <a onclick="Action(this)" class="btn btn-default btn-xs delete" data-act="delete" data-id="{!! $list->id !!}">{!! z_language('Delete') !!}</a> &nbsp;
                                <a onclick="Action(this)" class="btn btn-default btn-xs view" data-act="view" data-id="{!! $list->id !!}">{!! z_language('ViewSource') !!}</a>
                            </div>
                    </div>
                </li>
                @endforeach
                <li>
                    <button action="0" class="btn  btn-default" style="margin-left: 7px;" onclick="BuildAll(this,'delete')">Delete</button>
                </li>
            </ul>
        </div>
    </div>
