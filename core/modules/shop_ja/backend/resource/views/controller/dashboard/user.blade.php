    ...
    <script>
        ...
        $(document).ready(function () {
         ...
         //   $datepicker_start.datepicker('setDate',Date.parse('{!! date("Y-m-d", strtotime("first day of this month")) !!}'));
            ...
            var myDate1 = new Date({!! date("Y", strtotime("first day of this month")) !!},{!! (int)date("m", strtotime("first day of this month"))-1 !!},{!! (int)date("d", strtotime("first day of this month"))+2 !!});
