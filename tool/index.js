   ...
   // pages["YAMATO"].setViewport({ width: 1280, height:720 });
    ...
    function GetData(Cb){
        ...
        conn.connect(function (err){
            ...
            var sql = "SELECT * FROM `cms_shop_order_excel_tracking` where status != 1 and status<10 and (updated_at <= '"+timeEnd+"' or status = 2 and updated_at >= '"+moment().format("YYYY-MM-DD")+" 00:00:00' and updated_at <= '"+moment().format("YYYY-MM-DD")+" 23:59:59') order by updated_at LIMIT 0,20";
            console.log(sql);
