...
}elseif(isset($_0266372044c78247e24f23dde833a9ec_[$_lang_name_][$key])){
 $html = $_0266372044c78247e24f23dde833a9ec_[$_lang_name_][$key];
        ...
        <ul>
            ...
            <li>
                <div class="dropdown choose-country">
                    <a class="#" data-toggle="dropdown" href="#"><img src="@Zoe_Asset(theme/zoe/img/flags/gb.png)"
                                                                      alt="Great Britain"> UK</a>
                    <ul class="dropdown-menu" role="menu">
                        <li role="menuitem"><a href="#"><img src="@Zoe_Asset(theme/zoe/img/flags/us.png)"
                                                             alt="United States"> US</a></li>
                        <li role="menuitem"><a href="#"><img src="@Zoe_Asset(theme/zoe/img/flags/de.png)"
                                                             alt="Germany"> DE</a></li>
                        <li role="menuitem"><a href="#"><img src="@Zoe_Asset(theme/zoe/img/flags/es.png)" alt="Spain">
                                ES</a></li>
                    </ul>
                </div>
            </li>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="in-press press-wired">
                    <a href="#">
                        @zlang("Morbi eleifend congue elit nec sagittis. Praesent aliquam lobortis tellus, nec consequat vitae")
                    </a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
